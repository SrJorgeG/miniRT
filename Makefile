...
src/ray/ray.c src/ray/hits.c src/ray/hit_cylinder.c src/ray/hit_cylinder_aux.c \
src/ray/hits_cone.c src/ray/lighting.c src/ray/raycasting.c src/ray/raycasting_aux.c src/ray/ray_utils.c \
